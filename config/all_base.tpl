...
rule-providers:
  ...
  China: {type: http, behavior: classical, url: https://git.yumenaka.net/https://raw.githubusercontent.com/DivineEngine/Profiles/master/Clash/RuleSet/China.yaml, path: ./RuleSet/China.yaml, interval: 86400}
  Chinadomain: {type: http, behavior: classical, url: https://git.yumenaka.net/https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/Providers/ChinaDomain.yaml, path: ./RuleSet/Chinadomain.yaml, interval: 86400}
rules:
...
[General]
dns-server = 114.114.114.114, 223.5.5.5, 8.8.8.8, 208.67.222.222, system
