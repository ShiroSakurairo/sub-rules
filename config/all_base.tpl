...
rule-providers:
  ...
  Baneasylist: { type: http, behavior: classical, url: https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Clash/Providers/BanEasyList.yaml, path: ./Ruleset/BanEasyList.yaml, interval: 86400 }
  Baneasyprivacy: { type: http, behavior: classical, url: https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Clash/Providers/BanEasyPrivacy.yaml, path: ./Ruleset/BanEasyPrivacy.yaml, interval: 86400 }
...
RULE-SET,https://gitlab.com/ShiroSakurairo/subrule/-/raw/main/ruleset/surge/Fuckmangaad.list,🍓 Adblock,update-interval=86400
...
RULE-SET,https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Clash/BanEasyList.list,🍓 Adblock,update-interval=86400
